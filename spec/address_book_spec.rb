require_relative '../models/address_book'
 ...
 # #3
     ...
     it "imports the 1st entry" do
       ...
       # Check the first entry
       entry_one = book.entries[0]
       check_entry(entry_one, "Howard", "555-555-5415", "Howard@blocmail.com")
     end
     it "imports the 2nd entry" do
       book.import_from_csv("entries_2.csv")
       # Check the second entry
       entry_two = book.entries[1]
       check_entry(entry_two, "Kill","555-555-4854","kill@blocmail.com")
     end
     ...
     it "imports the 3rd entry" do
       ...
       # Check the third entry
       entry_three = book.entries[2]
       check_entry(entry_three, "Smoe", "555-555-3660", "Smoe@blocmail.com")
     end
   end
   ...
   describe "#iterative_search" do
     it "iterates over AddressBook for a non-existent entry" do
       book.import_from_csv("entries.csv")
